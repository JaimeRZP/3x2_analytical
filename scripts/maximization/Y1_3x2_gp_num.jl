...
W_lens_0 = npzread(string(nz_priors, "gp_lens_0.npz"))["W"]
W_lens_1 = npzread(string(nz_priors, "gp_lens_1.npz"))["W"]
W_lens_2 = npzread(string(nz_priors, "gp_lens_2.npz"))["W"]
W_lens_3 = npzread(string(nz_priors, "gp_lens_3.npz"))["W"]
W_lens_4 = npzread(string(nz_priors, "gp_lens_4.npz"))["W"]
W_source_0 = npzread(string(nz_priors, "gp_source_0.npz"))["W"]
W_source_1 = npzread(string(nz_priors, "gp_source_1.npz"))["W"]
W_source_2 = npzread(string(nz_priors, "gp_source_2.npz"))["W"]
W_source_3 = npzread(string(nz_priors, "gp_source_3.npz"))["W"]
W_source_4 = npzread(string(nz_priors, "gp_source_4.npz"))["W"]
...
for realization in 1:500
    ...
    alphas_2 = gp_params["lens_2"][:, realization]
    alphas_3 = gp_params["lens_3"][:, realization]
    alphas_4 = gp_params["lens_4"][:, realization]
    alphas_5 = gp_params["source_0"][:, realization]
    alphas_6 = gp_params["source_1"][:, realization]
    alphas_7 = gp_params["source_2"][:, realization]
    alphas_8 = gp_params["source_3"][:, realization]
    alphas_9 = gp_params["source_4"][:, realization]
    ...
    data = fake_data
    folpath = string("../../", method, "_fake_chains/maximization/Y1_3x2_gp_maximization/")
    #npzwrite(joinpath(folpath, string("data_", realization,".npz")), data=make_theory())
    println(string("Written data for ", realization,"!"))

    # Create the conditioned model with the alphas values fixed.
