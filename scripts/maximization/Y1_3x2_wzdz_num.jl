...
for realization in 1:10_000
    ...
    @model function model(data)
        ...
        theory := make_theory(Ωm=Ωm, Ωb=Ωb, h=h, σ8=σ8, ns=ns,
                                dz_lens_0=wzdz_0[0], wz_lens_0=wzdz_0[1],
                                dz_lens_1=wzdz_1[0], wz_lens_1=wzdz_1[1],
                                dz_lens_2=wzdz_2[0], wz_lens_2=wzdz_2[1],
                                dz_lens_3=wzdz_3[0], wz_lens_3=wzdz_3[1],
                                dz_lens_4=wzdz_4[0], wz_lens_4=wzdz_4[1],
                                dz_source_0=wzdz_5[0], wz_source_0=wzdz_5[1],
                                dz_source_1=wzdz_6[0], wz_source_1=wzdz_6[1],
                                dz_source_2=wzdz_7[0], wz_source_2=wzdz_7[1],
                                dz_source_3=wzdz_8[0], wz_source_3=wzdz_8[1],
                                dz_source_4=wzdz_9[0], wz_source_4=wzdz_9[1],
                                lens_0_b=lens_0_b,
                                lens_1_b=lens_1_b,
                                lens_2_b=lens_2_b, 
                                lens_3_b=lens_3_b,
