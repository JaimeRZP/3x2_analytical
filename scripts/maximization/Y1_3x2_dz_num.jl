...
function make_theory(;
    ...
    zs_lens_0 = files["nz_lens_0"][1]
    zs_lens_1 = files["nz_lens_1"][1]
    zs_lens_2 = files["nz_lens_2"][1]
    zs_lens_3 = files["nz_lens_3"][1]
    zs_lens_4 = files["nz_lens_4"][1]
    zs_source_0 = files["nz_source_0"][1]
    zs_source_1 = files["nz_source_1"][1]
    zs_source_2 = files["nz_source_2"][1]
    zs_source_3 = files["nz_source_3"][1]
    zs_source_4 = files["nz_source_4"][1]

    lens_0_zs   = @.(zs_lens_0 + dz_lens_0)
    lens_1_zs   = @.(zs_lens_1 + dz_lens_1)
    lens_2_zs   = @.(zs_lens_2 + dz_lens_2)
    lens_3_zs   = @.(zs_lens_3 + dz_lens_3)
    lens_4_zs   = @.(zs_lens_4 + dz_lens_4)
    source_0_zs = @.(zs_source_0 + dz_source_0)
    source_1_zs = @.(zs_source_1 + dz_source_1)
    source_2_zs = @.(zs_source_2 + dz_source_2)
    source_3_zs = @.(zs_source_3 + dz_source_3)
    source_4_zs = @.(zs_source_4 + dz_source_4)
