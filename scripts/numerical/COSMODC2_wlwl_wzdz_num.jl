...
@model function model(data)
    ...
    SnWs = dz_mean .+ dz_chol * alphas_source
    dzs_source := [SnWs[1], SnWs[3], SnWs[5], SnWs[7], SnWs[9]]
    wzs_source := [SnWs[2], SnWs[4], SnWs[6], SnWs[8], SnWs[10]]
...
folname = string("CosmoDC2_wlwl_Gibbs_wzdz_num_TAP_", TAP,  "_init_ϵ_", init_ϵ)
