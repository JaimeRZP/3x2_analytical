...
chol_lens_0 = Diagonal(nz_lens_0["chol"])
chol_lens_1 = Diagonal(nz_lens_1["chol"])
chol_lens_2 = Diagonal(nz_lens_2["chol"])
chol_lens_3 = Diagonal(nz_lens_3["chol"])
chol_lens_4 = Diagonal(nz_lens_4["chol"])
