...
@model function model(data)
    ...
    snw_lens_0 = chol_lens_0 * [0, alphas_lens_0[1]]
    wz_lens_0 := 1 + snw_lens_0[2]

    snw_lens_1 = chol_lens_1 * [0, alphas_lens_1[1]]
    wz_lens_1 := 1 + snw_lens_1[2]

    snw_lens_2 = chol_lens_2 * [0, alphas_lens_2[1]]
    wz_lens_2 := 1 + snw_lens_2[2]

    snw_lens_3 = chol_lens_3 * [0, alphas_lens_3[1]]
    wz_lens_3 := 1 + snw_lens_3[2]

    snw_lens_4 = chol_lens_4 * [0, alphas_lens_4[1]]
...
folname = string("CosmoDC2_gcgc_Gibbs_wz_num",
    "_TAP_", TAP,
    "_init_ϵ1_", init_ϵ1, 
    "_init_ϵ2_", init_ϵ2,
)
